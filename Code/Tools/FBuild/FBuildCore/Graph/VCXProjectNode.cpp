...
REFLECT_STRUCT_BEGIN_BASE( VSProjectConfigBase )
    ...
    REFLECT( m_RemoteRootDir, MetaInheritFromOwner() )
    REFLECT( m_RemoteProjectRelDir, MetaInheritFromOwner() )
    REFLECT( m_RemoteBuildCommandLine, MetaInheritFromOwner() )
    REFLECT( m_RemoteReBuildCommandLine, MetaInheritFromOwner() )
    REFLECT( m_RemoteCleanCommandLine, MetaInheritFromOwner() )
    REFLECT( m_RemoteBuildOutputs, MetaInheritFromOwner() )
    REFLECT( m_RemoteDebuggingMode, MetaInheritFromOwner() )
    REFLECT( m_RemoteGDBPath, MetaInheritFromOwner() )
    REFLECT( m_MIMode, MetaInheritFromOwner() )
